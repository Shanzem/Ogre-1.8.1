////////////////////////////////////////////////////////////////////////////////
//																			 
// 	Keyboard and mouse setup and working! Camera chase setup!.
//	Pitched and yawed like wanted :P.
//
...
//	If i can i can use the method below to spawn generic land.
//	Instead of the really bad grass. 
//
//	So set my entire map is using the static geometry and use
...
//
//	No node calling then should be better on RAM.
//
// 	Have a 3D object moving within a 3D volume. neat!
// 																	
//////////////////////////////////////////////////////////////////////////////
//
// Includes
